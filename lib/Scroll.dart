      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            CarouselSlider(
              items: [
                sliderItems("IPhone 12", "iphone12.jpg"),
                sliderItems("Note 20 Ultra", "Note20Ultra.jpg"),
                sliderItems("Macbook Air", "Macbook Air.jpg"),
                sliderItems("Macbook Pro", "Macbook Pro.jpg"),
              ],
            ...
            Container(
              ...
              child: GridView.count(
                  ...
                  children: [
                    techItems("IPhone 12", "iphone12.jpg"),
                    techItems("Note 20 Ultra", "Note20Ultra.jpg"),
                    techItems("Macbook Air", "Macbook Air.jpg"),
                    techItems("Macbook Pro", "Macbook Pro.jpg"),
                    techItems("Gaming PC", "GamingPC.jpg"),
                    techItems("Backlite Keyboard", "backlit-keyboards.jpg"),
                    techItems("Mercedes", "mercedes.jpg"),
                    techItems("Mutton", "mutton.jpg"),
                    techItems("Roadster", "roadster.jpg"),
                    techItems("Royal Field", "royal field.jpg"),
                  ]),
            ),
      ...
      child: Column(
        children: [
          ...
          Column(
            ...
            children: [
              Container(
                padding: EdgeInsets.only(top: 5, bottom: 3, left: 8),
                child: Text(
                  name,
